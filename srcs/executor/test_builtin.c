...
/*   Updated: 2019/06/18 11:30:19 by ghamelek         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	suit_unary_test(char **av, struct stat *buf)
{
	...
	{ ft_putstr_fd(av[0],2); ft_putstr_fd(": unknown condition: ",2); ft_putendl_fd(av[1], 2); return (2); } ft_putstr_fd("42sh: parse error: condition expected: ",2); ft_putendl_fd(av[1], 2); return (1);
}
