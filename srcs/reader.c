...
/*   Updated: 2019/05/12 07:09:59 by aben-azz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_clear_all_lines(t_cap *tcap)
{
	...
	ft_dprintf(fd, "%d up, %d prompt, condition %d + %d > %d == %d\n",
	tcap->cursy + 1, tcap->prompt_len, tcap->char_len, tcap->prompt_len ,
	tcap->cursx_max + 1, tcap->char_len + tcap->prompt_len > tcap->cursx_max + 1);
